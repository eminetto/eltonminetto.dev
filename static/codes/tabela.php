...
/** 
  ...
  * Elton Luís Minetto <eminetto at gmail dot com>
  * Licença: GPL 
  */
	...
	*/
	public function update($where) {
		...
		try { 
			...
			echo "Erro na atualizaï¿½ï¿½o:<br>SQL:".$sql.'<br>Erro:'.$e->getMessage().'<br><a href="javascript:history.go(-1)">Voltar</a>';
			exit;
		}
	}
	...
	*/
	public function delete($where=null) {
		...
		try { 
			...
			echo "Erro na exclusÃ£o:".$e->getMessage().'<br><a href="javascript:history.go(-1)">Voltar</a>';
			exit;
		}
	}
